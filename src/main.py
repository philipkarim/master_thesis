...
def main():
    ...
    #fraud_detection(Ham2, ansatz2, 50, 0.01, optimizing_method, 0.99, 0, v_q=1, layers=NN_nodes(8,5), ml_task='classification', directory='final_run_fraud_90'+'network', name='H1_8_5_400_50_f_90', samp_400=True)
