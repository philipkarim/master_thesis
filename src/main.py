...
def main():
    ...
    quantum_mnist(1, ansatz2, n_epochs=100, lr=0.01, optim_method=optimizing_method, layers=None, QBM='NN', samp_400=True, big_mnist=False)#[[[8,1],[8,1]], [0, 1]])#000509_40_samples_both_sets')
